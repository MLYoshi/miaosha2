...
import com.example.user.support.AbstractUserIntegrationTest;
...
/** F1-F5：注册/登录链路与 JWT 拦截（复刻 backend AuthApiTest 的 user 域场景）。 */
class AuthApiTest extends AbstractUserIntegrationTest {
